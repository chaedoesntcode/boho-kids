...
const SocialMediaFeed = () => {
  return (
    ...
    <section className="bg-lightGray/50 w-full px-4 lg:px-20 py-10 flex flex-col gap-4 align-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mx-auto">
        <div className="hover:cursor-pointer">
          <Image
            ...
            className="rounded-xl media-img hover:scale-105 transition-transform duration-300 bg-gray-300"
          />
          <p className="text-black/70 flex gap-1 items-center">
            <FaHeart className="ml-1 text-yellow" />
            31K
          </p>
        </div>
        <div className="hover:cursor-pointer">
          <Image
            ...
            width={400}
            height={400}
            alt="Closeup of an instrument leaning against a wall"
            className="rounded-xl media-img hover:scale-105 transition-transform duration-300 bg-gray-300"
          />
          <p className="text-black/70 flex gap-1 items-center">
            <FaHeart className="ml-1 text-yellow" />
        ...
        <div className="hover:cursor-pointer">
          <Image
            ...
            width={400}
            height={400}
            alt="Two boys having a pillow fight, with pillows in mid-air"
            className="rounded-xl media-img hover:scale-105 transition-transform duration-300 bg-gray-300"
          />
          <p className="text-black/70 flex gap-1 items-center">
            <FaHeart className="ml-1 text-yellow" />
        ...
        <div className="hover:cursor-pointer">
          <Image
            ...
            width={400}
            height={400}
            alt="Desk workspace featuring wall art, plants, and a computer"
            className="rounded-xl media-img hover:scale-105 transition-transform duration-300 bg-gray-300"
          />
          <p className="text-black/70 flex gap-1 items-center">
            <FaHeart className="ml-1 text-yellow" />
